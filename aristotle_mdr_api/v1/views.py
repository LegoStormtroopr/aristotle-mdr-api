...
class ConceptSerializerBase(serializers.ModelSerializer):
    api_url = serializers.HyperlinkedIdentityField(view_name='aristotle_mdr_api.v1:_concept-detail', format='html')
...
class ConceptDetailSerializer(ConceptSerializerBase):
    superseded_by = serializers.HyperlinkedRelatedField(view_name='aristotle_mdr_api.v1:_concept-detail', format='html',read_only='True')
    supersedes = serializers.HyperlinkedRelatedField(many=True,view_name='aristotle_mdr_api.v1:_concept-detail', format='html',read_only='True')
